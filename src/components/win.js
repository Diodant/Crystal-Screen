const winnersData = {
    2018: {
      ...
      television: [
        ...
        { title: "Лучший художник по свету телевизионного проекта", winner: "Игорь Коваленко за проект «Тайны большого города»", text: "Его мастерское использование светотени создало захватывающую атмосферу мистики и напряжения, подчеркнув драматургию сюжета.", year: "2018" },
    ...
    2019: {
      ...
      television: [
        ...
        { title: "Лучший художник по свету телевизионного проекта", winner: "Богдан Карплевский за программу “Х-Фактор”", text: "Жюри отметило создание сложных световых решений, способствующих эмоциональному восприятию шоу.", year: "2019" },
    ...
    2020: {
      ...
      television: [
        ...
        { title: "Лучший художник по свету телевизионного проекта:", winner: "Виктория Кравцова за проект «Dance Революция»", text: "Виктория использовала динамические световые эффекты, подчеркивая пластику движений танцоров и создавая атмосферу зрелищного шоу.", year: "2020" },
    ...
    2021: {
      ...
      television: [
        ...
        { title: "Лучший художник по свету телевизионного проекта", winner: "Дмитрий Лебедев за проект «Мир наизнанку»", text: "Дмитрий виртуозно адаптировал световые решения под экстремальные условия съёмок, усиливая реалистичность и эмоциональное восприятие документального контента.", year: "2021" },
    ...
    2022: {
      ...
      television: [
        ...
        { title: "Лучший художник по свету телевизионного проекта", winner: "Ольга Васильева за проект «МастерШеф»", text: "Её умелое использование цветовых акцентов и контрастов сделало процесс приготовления блюд визуально привлекательным и динамичным.", year: "2022" },
        ...
        { title: "Лучший продюсер телевизионного проекта", winner: "Оксана Кириллова за телевизионный проект «Музыкальная интуиция» (телеканал ТНТ)", text: "Жюри отметило ее вклад в создание успешного и популярного проекта.", year: "2022" },
      ]
    },
    2023: {
      number: 'VI',
      ...
      television: [
        ...
        { title: "Лучший художник по свету телевизионного проекта", winner: "Анна Сидоренко за проект «Сила Танца»", text: "Её игра света и тени добавила мистики и загадочности, усилив драматизм сцен и создавая атмосферу таинственности.", year: "2023" },
    ...
    2024: {
      ...
      television: [
        ...
        { title: "Лучший художник по свету телевизионного проекта", winner: "Максим Власов за проект «Голос страны»", text: "Максим виртуозно использовал динамическое освещение, синхронизированное с музыкальными номерами, создавая эффект полного погружения и эмоциональной вовлеченности зрителей.", year: "2024" },
